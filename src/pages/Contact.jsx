    ...
    <div className="min-h-screen bg-green-50 flex items-center justify-center p-10">
      ...
      >
        ...
        <form className="space-y-6" onSubmit={(e) => {
          e.preventDefault();
          alert("Message sent! 🚀 (This is a demo, no real message was sent yet)");
        }}>
          <div>
            <label className="block text-gray-700 font-bold mb-2 text-xl">Name</label>
            <input type="text" required className="w-full p-4 border-2 border-green-200 rounded-xl focus:outline-none focus:border-green-500 transition-colors text-lg" placeholder="Your Name" />
          </div>
          <div>
            <label className="block text-gray-700 font-bold mb-2 text-xl">Email</label>
            <input type="email" required className="w-full p-4 border-2 border-green-200 rounded-xl focus:outline-none focus:border-green-500 transition-colors text-lg" placeholder="your@email.com" />
          </div>
          <div>
            <label className="block text-gray-700 font-bold mb-2 text-xl">Message</label>
            <textarea required className="w-full p-4 border-2 border-green-200 rounded-xl focus:outline-none focus:border-green-500 transition-colors h-40 text-lg" placeholder="Say hello!"></textarea>
          </div>
